...
model ExperimentalDrivetrain
  ...
  Components.SimpleAxisFront simpleAxisFront(
    ...
    wheelRight(phi_roll(fixed=true), w_roll(fixed=true)))
...
equation
  ...
  connect(body.frame_a, simpleAxisFront.frameChassis) annotation (Line(
      points={{10,-20},{10,0}},
      color={95,95,95},
      thickness=0.5));
