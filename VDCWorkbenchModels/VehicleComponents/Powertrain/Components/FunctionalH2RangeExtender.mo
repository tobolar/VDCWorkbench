...
equation
  ...
  connect(H2_tank.y, rexBus.H2TankContent) annotation (Line(points={{61,-10},{
          66,-10},{66,-30},{100,-30}},                                                                             color={0,0,127}), Text(
      string="%second",
      index=3,
      extent={{3,3},{3,3}},
      horizontalAlignment=TextAlignment.Left));
  connect(H2power.y, rexBus.H2Power) annotation (Line(points={{-21,10},{100,10},{100,-30}},
      ...
      extent={{6,3},{6,3}},
      horizontalAlignment=TextAlignment.Left));
  connect(H2_tank.y, SoC.u) annotation (Line(points={{61,-10},{70.8,-10}},
        color={0,0,127}));
