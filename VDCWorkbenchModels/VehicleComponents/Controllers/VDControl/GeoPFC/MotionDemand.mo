...
equation
  ...
  connect(x_path, motionDemandBus.x_path)
    annotation (Line(points={{-50,32},{-12,32},{-12,0},{-10,0}},
                                                     color={0,0,127}));
  connect(y_path, motionDemandBus.y_path) annotation (Line(points={{-50,12},{-14,12},{-14,0},{-10,0}},
                              color={0,0,127}));
  connect(psi_path, motionDemandBus.psi_path) annotation (Line(points={{-50,-8},{-12,-8},{-12,0},{-10,0}},
                                             color={0,0,127}));
  connect(v_path, motionDemandBus.v_path)
    annotation (Line(points={{-50,-28},{-10,-28},{-10,0}},
                                                       color={0,0,127}));
  connect(kappa_path, motionDemandBus.kappa_path) annotation (Line(points={{-50,-48},{-8,-48},{-8,0},{-10,0}},
                                                           color={0,0,127}));
  connect(beta.y, motionDemandBus.beta_geo)
    annotation (Line(points={{-39,80},{-8,80},{-8,0},{-10,0}},
                                                           color={0,0,127}), Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}},
      horizontalAlignment=TextAlignment.Left));
  connect(kappaICR.y, motionDemandBus.kappaICR_geo) annotation (Line(points={{-39,60},{-10,60},{-10,0}},
                                                                                                     color={0,0,127}), Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}},
      horizontalAlignment=TextAlignment.Left));
  connect(vveh, chassisBus.longitudinalVelocity) annotation (Line(points={{40,-10},{80,-10},{80,0}},
                            color={0,0,127}), Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}},
