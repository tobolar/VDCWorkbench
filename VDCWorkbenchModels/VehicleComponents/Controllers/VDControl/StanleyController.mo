...
model StanleyController "Stanley-based path following control"
  ...
  parameter Data.Tracks.Racetrack track;
equation
  ...
  connect(stanleyControl.controlBus, controlBus) annotation (Line(
      ...
      color={255,204,51},
      thickness=0.5));
  connect(stanleyControl.delta, chassisControlBus.steeringWheelAngle)
