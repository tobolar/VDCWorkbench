...
expandable connector ScoreBus
  "Bus of VDCWorkbenchModels.Utilities.Interfaces: Empty expandable connector used for score values of the EMA"
  extends Modelica.Icons.SignalSubBus;

  annotation (
    defaultComponentName="ScoreBus",
