...
expandable connector EMAControls
  "Bus of VDCWorkbenchModels.Utilities.Interfaces: Empty expandable connector used for EMA control variables"
  extends Modelica.Icons.SignalSubBus;

  annotation (
    defaultComponentName="EMAcontrols",
