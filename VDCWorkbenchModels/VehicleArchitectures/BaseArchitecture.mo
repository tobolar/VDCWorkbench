...
a&nbsp;drive train or aa&nbsp;braking assembly.
</p>

<p>
Note: this architecture is <em>partial</em> since there is missing a&nbsp;signal for
the vehicle&apos;s steering wheel. It is provided by the signal <code>steeringWheelAngle</code>
...
This signal must be connected to the <code>chassisControlBus</code> in the model which
