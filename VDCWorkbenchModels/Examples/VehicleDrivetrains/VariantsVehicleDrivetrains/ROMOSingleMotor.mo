...
model ROMOSingleMotor "Architecture of the ROMO planar vehicle with rear central traction motor"
...
prescribed by a&nbsp;table. This torque demand is realized by a&nbsp;traction
motor which is connected to the central rear drive flange
of the vehicle. 
